...
const outRoot = '/home/zanbo/zanbotest/tmp/layout-quickscan-20260412-v2'
const routes = [
...
async function inspect(page) {
  return page.evaluate(() => {
    ...
    const bodyTxt = String(document.body?.innerText || '').replace(/\s+/g, ' ').trim()
    return {
...
;(async () => {
  ...
  console.log('saved quickscan v2 summary')
})()
